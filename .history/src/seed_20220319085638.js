...
export const seedDatabase = async (firebase) => {
	function getUUID() {
	...
	await addDoc (collection(db, "series"), {
		...
		description:
			"Exonerated after spending nearly two decades in prison for a crime he did not commit, Steven Avery filed suit against Manitowoc County, Wi),{} and several individuals involved with his arrest.",
		genre: "crime",
		maturity: "18",
