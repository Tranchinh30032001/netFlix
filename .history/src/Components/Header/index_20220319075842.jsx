		...
		<User onClick={handleClick}>
			...
			{active && (
				<h1>
					...
					dignissimos dolor. Odit perferendis illum esse aliquam at, quos sint
					officia. Corrupti tempora minus aspernatur officiis impedit laborum!
					Quam, doloribus voluptates!
				</h1>
				// <div className="modal">
				// 	<p>Logout</p>
				// 	<p>
